          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '40px', marginBottom: '40px' }}>
            ...
            <div>
              ...
              <p style={{ lineHeight: 1.6, color: '#666666' }}>
                A registered, independent non-profit human rights organisation defending constitutional civil rights, civil liberties, and institutional accountability in the Republic of India.
              </p>
            </div>
